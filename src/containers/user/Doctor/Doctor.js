      ...
      <div className="DoctorPageContent">
        <div className="DoctorInfo">
          <div className="DoctorHighlight">
            <div className="bold DoctorHighlightHeader">Điểm nổi bật nhất</div>
            <div className="DoctorHighlightContent">
              <ul className="ListHighlight">
                ...
                <li className="Highlight">
                  <b>5 năm kinh nghiệm tư vấn, khám và điều trị đa khoa:</b> Bác
                  sĩ tốt nghiệp Bác sĩ đa khoa tại trường Đại học Y Dược Cần
                  Thơ, có hơn 5 năm kinh nghiệm trong việc thăm khám và tư vấn.
                </li>
                <li className="Highlight">
                  <b>Nhiệt tình tư vấn trong thăm khám:</b> Bác sĩ luôn thăm
                  khám với thái độ tận tình tận tâm, nhiệt huyết trong quá trình
                  tư vấn bệnh lý.
                </li>
              </ul>
            </div>
          ...
          <div className="DoctorBasicInfo">
            ...
            <div className="Content">
              <div className="BasicInfo">
                ...
                <p>
                  Sở hữu nền tảng chuyên môn vững chắc, bác sĩ tốt nghiệp Bác sĩ
                  đa khoa tại trường Đại học Y Dược Cần Thơ. Bên cạnh đó, bác sĩ
                  còn sở hữu các chứng chỉ về tim mạch, thường xuyên tham gia
                  các hội nghị khoa học của Hội Tim mạch Việt Nam.
                </p>
                <p>
                  Hiện tại, bác sĩ chuyên thăm khám và điều trị các vấn đề bệnh
                  lý nội khoa, đa khoa, tư vấn tiêm chủng. Với tinh thần trách
                  nhiệm cao cũng như sự ân cần và chu đáo trong việc tư vấn,
                  khám, bác sĩ nhận được nhiều đánh giá tích cực từ các bệnh
                  nhân đến điều trị.
                </p>
              </div>
                  ...
                  <div className="Content">
                    <ul className="ListExperiences">
                      <li className="Experience">
                        ...
                        <div className="ExperienceDetails">2019 - Hiện tại</div>
                      </li>
                      <li className="Experience">
                        <div className="ExperienceHeader">
