...
const UserInfo = () => {
  ...
  const [nameOld, setNameOld] = useState(user?.user?.name);
  const [birthdayOld, setBirthdayOld] = useState(user?.user?.birthday);
  const [adressOld, setAdressOld] = useState(user?.user?.address);
  const [genderOld, setGenderOld] = useState(user?.user?.gender);
  const [phoneOld, setPhoneOld] = useState(user?.user?.phone);
  const [usernameOld, setUsernameOld] = useState(user?.account?.username);
  const editUserInfo = async () => {
    let res = await editUser(id, nameOld);
    if (res) {
            ...
            <form className="UserPersonalInfo">
              <div className="ListPersonalInfos clear">
                ...
                <li className="PersonalInfo">
                  ...
                  <p className="PersonalInfoData">{user?.name}</p>
                </li>
                <li className="PersonalInfo">
                  <p className="PersonalInfoHeader">
                    <b>Email</b>
